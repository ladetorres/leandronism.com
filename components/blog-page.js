...
const BlogPage = props => (
  <>
    <BaseHead
      title={props.head}
      image={`https://leandronism.com${props.src.src}`}
      description={props.subtitle}
      url={`https://leandronism.com${props.url}`}
    />
    <Header />
    <div
      className="h-blog-page h-blog-page-xs sm:h-blog-page-sm md:h-blog-page-sm lg:h-blog-page w-blog-page-xs sm:w-blog-page-sm md:w-blog-page-md lg:w-blog-page relative mx-auto"
    >
    ...
    <div className="w-blog-content-xs sm:w-blog-content-sm md:w-blog-content-md lg:w-blog-content relative mx-auto font-nunito font-200">
      <div>
        ...
        <div className={props.photoCreditString ? "hidden" : "text-12 text-granite-rock"}>
          ...
          {" "}on{" "}
          <a href="https://unsplash.com/s/photos/laptop?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText" className="underline">
            Unsplash
          </a>
        </div>
